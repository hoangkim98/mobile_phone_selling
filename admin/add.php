<?php
  ...
  if (isset($_POST["des"]) && isset($_POST["name"]) && isset($_POST["price"]) && isset($_POST["kind"])){
    ...
    $query = "INSERT INTO `products`( `name`, `description`, `price`, `kind`) VALUES (?,?,?,?)";
    $array = array($name,$dcr,$price,$kind);
...
<html>
  ...
  Click <a href="tables.php">here</a> to view Tables
		...
		<input  type="submit" name="submit" value="Add" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
