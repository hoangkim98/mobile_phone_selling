    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <div class="d-flex justify-content-end">
            <a href="add_image.php" class="btn btn-info " role="button">Add Product Images</a>
            <br/>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <?php
                    ...
                    echo "<td><a href=\"edit_image.php?id=$row[id]\">Edit</a> | <a href=\"delete_image.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                    echo "</tr>";
                  }
                  ?>
                </tbody>
